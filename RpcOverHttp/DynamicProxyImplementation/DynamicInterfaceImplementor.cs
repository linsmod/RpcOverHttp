...
namespace DynamicProxyImplementation
{
    public class DynamicInterfaceImplementor : IDynamicInterfaceImplementor
    {
        ...
        public virtual Type CreateType(Type interfaceType, Type dynamicProxyBaseType)
        {
            ...
            {
                throw new NotSupportedException("non public interface is not supported.");
            }
            ...
            try
            {
                ...
                if (ret == null)
                {
                    TypeBuilder tb = moduleBuilder.DefineType(typeName, TypeAttributes.NotPublic);
        ...
        private void EmitInvokeMethod(MethodInfo mi, MethodBuilder mb)
        {
            ...
            //C#: ret = DynamicProxy.TryInvokeMember(interfaceType, methodId, propertyName, params, out result)
